...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 160  --35, 50
-- TRAJECTORY_BUILDER_2D.min_range = 0.2  --0.3
-- TRAJECTORY_BUILDER_2D.max_range = 12.  --8
TRAJECTORY_BUILDER_2D.missing_data_ray_length = 15.  --1
...
POSE_GRAPH.optimize_every_n_nodes = 45  --35, 50
POSE_GRAPH.constraint_builder.min_score = 0.7  --0.65, 0.7
